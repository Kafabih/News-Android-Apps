package com.svck.ilovemovie.data.network.httpclient
...
fun coroutinesServices(restAdapter: Retrofit): MovieServices {
    return restAdapter.create(MovieServices::class.java)
}