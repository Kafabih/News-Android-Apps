package com.svck.ilovemovie.domain.adapter
...
import com.svck.ilovemovie.external.extension.inflate
import com.svck.ilovemovie.external.extension.viewBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        ...
        itemView.setOnClickListener {
            ...
            if (adapterPosition != RecyclerView.NO_POSITION) {
                ...
                onItemClickWithBinding(viewBinding,itemView,adapterPosition)
            }
        }
...
//        notifyItemChanged(position)
    ...
    protected open fun onItemClickWithBinding(binding:T?,itemView: View, position: Int) {}
